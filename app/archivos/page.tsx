...
const volumen1: { title: string; subtitle: string; sections: Section[] } = {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12">
          <div className="mb-8">
            <div className="mb-4">
              <div className="flex flex-wrap items-center gap-2 md:gap-3">
                <h2 className="text-xl md:text-2xl font-bold text-blue-800 break-words">{volumen1.title}</h2>
          ...
          <div className="space-y-8">
            {volumen1.sections.map((section, sectionIndex) => (
